...
[Wave Specification](docs/waves/W1-vault-lezen/01-spec.md) is goedgekeurd; het
[Test & Verification Plan](docs/waves/W1-vault-lezen/02-testplan.md) wacht op
goedkeuring. Daarna kan W1 gebouwd worden.
...
| [W1 – Wave Specification](docs/waves/W1-vault-lezen/01-spec.md) | Het implementatiecontract voor W1 | ✅ goedgekeurd |
| **[W1 – Test & Verification Plan](docs/waves/W1-vault-lezen/02-testplan.md)** | **Wat er bewezen moet worden vóór er code is** | ⏳ **ter goedkeuring** |
