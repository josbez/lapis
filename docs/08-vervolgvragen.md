...
2. **Mappen zijn geen implementatiedetail maar een productbesluit.** In alle drie de
...
3. **"Zonder de vibe-code-esthetiek" (A1) is een eis, geen bijzin.** Voor een UX-designer
...
|---|:-:|:-:|:-:|
| Plugin-systeem | ☐ | ☐ | ☐ |
| Thema-store / aanpasbare CSS | ☐ | ☐ | ☐ |
| Graph view | ☐ | ☐ | ☐ |
| Canvas / whiteboard | ☐ | ☐ | ☐ |
| Eigen sync-dienst | ☐ | ☐ | ☐ |
| Samenwerking / commentaren | ☐ | ☐ | ☐ |
| AI-chat met je notities | ☐ | ☐ | ☐ |
| Query-taal (Dataview-achtig) | ☐ | ☐ | ☐ |
| Sjabloon-systeem | ☐ | ☐ | ☐ |
| Tabs / split-panes / workspaces | ☐ | ☐ | ☐ |
| Backlinks-paneel | ☐ | ☐ | ☐ |
| Daily notes | ☐ | ☐ | ☐ |
