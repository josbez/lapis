...
kunnen gebruiken; daar zijn W9 en W10 voor nodig."* Beide staan er nu, W10 inclusief het
echte ontwerp — de eerste echte gebruikstest tegen Jos' eigen vault is dus de volgende
stap, en pas daarna is er iets om te toetsen aan het succescriterium uit
[PRD §6](03-prd.md#6-succescriteria).
